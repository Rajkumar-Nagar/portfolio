...
export function BackgroundBeamsWithCollisionDemo() {
    return (
        <BackgroundBeamsWithCollision>
            <div className="flex flex-col-reverse md:flex-row items-center  bg-black text-white h-[calc(100vh_-_4rem)]">
                {/* Left Section: Welcome Message and About Me */}
                <div className="flex-1 w-full sm:px-10 px-4 flex items-center justify-center">
                    <div className="w-full ml-auto max-w-screen-sm">
                        ...
                        <p className="text-lg lg:text-xl font-light">
                            Hii, {`I'm`} Rajkumar, a passionate full-stack developer and competitive programmer.
                        </p>
                    </div>
                </div>

                {/* Right Section: Image with added hover effects */}
                <div className="h-[calc(100vh_-_4rem)] hidden md:block relative max-w-[400px] w-full overflow-hidden">
